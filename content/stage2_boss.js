...
function _pell_resolve_expose() {
  ...
  if (roll.total >= dc) {
    ...
    addNarration('', 'The dates are there but you cannot hold them cleanly under pressure — the division log, the complaint file, the assignment chain. Pell watches you lay the argument out and waits until you stop. "In accordance with division procedure, assignment timing is an administrative matter, not subject to external review." His voice has not changed once in this meeting. He closes the folder. "I will note your concern. The inquiry remains open."');
    G.worldClocks = G.worldClocks || {};
    G.worldClocks.watchfulness = (G.worldClocks.watchfulness || 0) + 2;
