  ...
  // 7. RITUAL KEEPER: RITUAL CORRUPTED
  {
    ...
    fn: function() {
      ...
      if (result.isCrit) {
        ...
        G.lastResult = `Marin permits access to the current ceremony texts. Several formulas show variant language from the traditional forms — small substitutions embedded in the archaic binding-law phrasing where substitutions are hardest to detect without a direct comparison. Whether the variants are scholarly reinterpretation or deliberate corruption requires side-by-side analysis with the original archived scrolls, which Marin hasn't offered access to. The ceremony hall beyond the archive door carries the faint sound of coin being counted somewhere behind the partition — the ward clerk's annex, running its routine even while the ritual space stays quiet.`;
