...
(function () {
  ...
  var NPC_LOOKUP = {
    ...
    vorgul_oxtend: {
      ...
      choice_label: 'Vorgul Oxtend signs every batch report even when the numbers don\'t add up. He knows the cost.',
    ...
    decon_von_reckshem: {
      ...
      choice_label: 'Decon von Reckshem keeps two disputes in reserve. Courtesy and favor are not the same thing.',
