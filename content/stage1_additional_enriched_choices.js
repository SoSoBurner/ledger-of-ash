...
var STAGE1_ADDITIONAL_ENRICHED_CHOICES = [
...

  {
    ...
    fn: function() {
      ...
      gainXp(15, 'community good faith');
  ...
  // ========== SAFE HAVEN ESTABLISHMENT ==========
  {
    ...
    fn: function() {
      ...
      gainXp(15, 'establishing presence');
  ...
  // ========== SKILL PRACTICE (No risk, pure development) ==========
  {
    ...
    fn: function() {
      ...
      gainXp(15, `skill refinement - ${skillName}`);
  ...
  // ========== RELATIONSHIP NEUTRALITY ==========
  {
    ...
    fn: function() {
      ...
      if (factions.length > 1) {
        ...
        gainXp(15, 'neutral intelligence gathering');
        ...
        gainXp(15, 'power structure analysis');
      }
      G.recentOutcomeType = 'observe';
      maybeStageAdvance();
    }
