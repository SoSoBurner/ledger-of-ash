  ...
  // ——— SERVICE 2: WORLD-COLOR RUMOR ———
  {
    ...
    fn: function() {
      ...
      const rumors = [
        ...
        "A herbalist in the Verdant Row told Lorn that three of her regular customers moved out of the district last month. Not relocated — moved away. They all lived within two blocks of a reservoir access terminal.",
        ...
        "Wren counted eight new structures within the Shelkopolis outer districts in the past year — all listed as maintenance facilities, all within three hundred meters of a reservoir access terminal.",
