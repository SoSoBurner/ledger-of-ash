...
var HARVEST_CIRCLE_STAGE1_ENRICHED_CHOICES = [
  ...
  // 1. GRAIN MEASURER: QUOTA MANIPULATION
  {
    ...
    failResult: {
      ...
      xp: 0,
      effects: [],
      next: [{text: 'The land protector works the eastern fields.', skill: 'survival', tag: 'safe', align: 'neutral', cid: '__arrive__'}]
    },
    fn: function() {
      advanceTime(1);
      G.telemetry.turns++;
  ...
  // 3. PROTECTOR OF MAGICAL FORESTS: LAND CORRUPTION
  {
    ...
    failResult: {
      ...
      xp: 0,
      effects: [],
      next: [{text: 'The Halversen family farms the eastern border strip.', skill: 'persuasion', tag: 'safe', align: 'neutral', cid: '__arrive__'}]
    },
    fn: function() {
      advanceTime(1);
      G.telemetry.turns++;
  ...
  // 4. STORAGE KEEPER: GRAIN DIVERSION
  {
    ...
    failResult: {
      ...
      xp: 0,
      effects: [],
      next: [{text: 'The distribution hall staging log is a different authority.', skill: 'lore', tag: 'safe', align: 'neutral', cid: '__arrive__'}]
    },
    fn: function() {
      advanceTime(1);
      G.telemetry.turns++;
  ...
  // 6. RECORD KEEPER: DOCUMENT FALSIFICATION
  {
    ...
    failResult: {
      ...
      xp: 0,
      effects: [],
      next: [{text: 'The public register tracks documentation format changes.', skill: 'lore', tag: 'safe', align: 'neutral', cid: '__arrive__'}]
    },
    fn: function() {
      advanceTime(1);
      G.telemetry.turns++;
      ...
      if (result.isCrit) {
        G.lastResult = `Farlan has the evidence already assembled — he's been waiting for someone to ask. "Look at the delivery record for the Coalward family, third week of last season." He sets it beside a summary sheet on the reading room table, the chalk dust of the tally marks still faintly visible at the sheet's margin. The delivery figure on the record is higher than the summary confirms. "That change happened after the document was signed. The ink shade is different — look at the column edge." He stacks the six flagged documents with careful deliberateness. "Grain delivered in one quantity, recorded in another. The recordkeeping is supposed to prevent this. Someone changed what goes into the records, and they did it after the original was signed."`;
  ...
  // 7. INSPECTOR: QUALITY SUPPRESSION
  {
    ...
    failResult: {
      ...
      xp: 0,
      effects: [],
      next: [{text: 'The compliance records are open during the inspector\'s afternoon rounds.', skill: 'survival', tag: 'safe', align: 'neutral', cid: '__arrive__'}]
    },
    fn: function() {
      advanceTime(1);
      G.telemetry.turns++;
      ...
      if (result.isCrit) {
        G.lastResult = `Garren keeps his voice low and his back to the lantern above the grain scales. "I mark the grain. I file the mark. Two days later I check the record and the mark is gone — passed, no note, nothing." He holds up his inspection log beside the official record; the grain store smells of dried chaff and old timber around them both. Same batch, two different outcomes, the columns side by side. "I've been told directly: connected-family grain passes. I had a batch last month, Halversen family — quality grain — flagged for minor moisture variance. Supervisor overruled it." He sets both logs flat. "The grain from that Halversen flag was good. The batch that passed without a flag — I won't eat from it."`;
  ...
  // 8. DISPUTE MEDIATOR: CONFLICT RESOLUTION FAILURES
  {
    ...
    failResult: {
      ...
      xp: 0,
      effects: [],
      next: [{text: 'The Halversen family knows what the mediator ruled against them.', skill: 'persuasion', tag: 'safe', align: 'neutral', cid: '__arrive__'}]
    },
    fn: function() {
      advanceTime(1);
      G.telemetry.turns++;
  ...
  // 9. GRAIN SYSTEM HIERARCHY: AUTHORITY REORGANIZATION
  {
    ...
    failResult: {
      ...
      xp: 0,
      effects: [],
      next: [{text: 'The elder council\'s posted session minutes go back eighteen months.', skill: 'lore', tag: 'safe', align: 'neutral', cid: '__arrive__'}]
    },
    fn: function() {
      advanceTime(1);
      G.telemetry.turns++;
  ...
  // 10. FARMING NETWORKS: FAMILY DISPLACEMENT
  {
    ...
    failResult: {
      ...
      xp: 0,
      effects: [],
      next: [{text: 'The appeal filing records are public and held separately from the roster.', skill: 'lore', tag: 'safe', align: 'neutral', cid: '__arrive__'}]
    },
    fn: function() {
      advanceTime(1);
      G.telemetry.turns++;
  ...
  // 11. SPOILAGE SYSTEM: DEGRADATION ACCELERATION
  {
    ...
    failResult: {
      ...
      xp: 0,
      effects: [],
      next: [{text: 'The maintenance schedule at the yard entrance is public-facing.', skill: 'survival', tag: 'safe', align: 'neutral', cid: '__arrive__'}]
    },
    fn: function() {
      advanceTime(1);
      G.telemetry.turns++;
  ...
  // 12. FAMILY POWER TRACKING: WHO'S RISING
  {
    ...
    failResult: {
      ...
      xp: 0,
      effects: [],
      next: [{text: 'The personnel register holds the council chair replacement record.', skill: 'lore', tag: 'safe', align: 'neutral', cid: '__arrive__'}]
    },
    fn: function() {
      advanceTime(1);
      G.telemetry.turns++;
  ...
  // 13. QUOTA DEPENDENCY: CONTROL SYSTEM
  {
    ...
    failResult: {
      ...
      xp: 0,
      effects: [],
      next: [{text: 'The quota intake form lays out the credit terms plainly.', skill: 'lore', tag: 'safe', align: 'neutral', cid: '__arrive__'}]
    },
    fn: function() {
      advanceTime(1);
      G.telemetry.turns++;
  ...
  // 15. FIELD RUMOR: FARMER WHISPERS
  {
    ...
    failResult: {
      ...
      xp: 0,
      effects: [],
      next: [{text: 'The communal fire draws crews together after the authority building closes.', skill: 'persuasion', tag: 'safe', align: 'neutral', cid: '__arrive__'}]
    },
    fn: function() {
      advanceTime(1);
      G.telemetry.turns++;
  ...
  // 16. MARKET RUMOR: MERCHANT WHISPERS
  {
    ...
    failResult: {
      ...
      xp: 0,
      effects: [],
      next: [{text: 'The festival square stalls in the late afternoon draw less careful conversation.', skill: 'persuasion', tag: 'safe', align: 'neutral', cid: '__arrive__'}]
    },
    fn: function() {
      advanceTime(1);
      G.telemetry.turns++;
  ...
  // 17. INSTITUTIONAL CRACK: CORRUPTION PROOF COMPILATION
  {
    ...
    failResult: {
      ...
      xp: 0,
      effects: [],
      next: [{text: 'The outbound staging area receives outside courier traffic twice weekly.', skill: 'survival', tag: 'safe', align: 'neutral', cid: '__arrive__'}]
    },
    fn: function() {
      advanceTime(1);
      G.telemetry.turns++;
  ...
  // 18. MORAL PRESSURE: FAMILY LOYALTY COMPROMISE CHOICE
  {
    ...
    failResult: {
      ...
      xp: 0,
      effects: [],
      next: [{text: 'The weighing station is unwatched in the early morning before the authority shift begins.', skill: 'persuasion', tag: 'safe', align: 'neutral', cid: '__arrive__'}]
    },
    fn: function() {
      advanceTime(1);
      G.telemetry.turns++;
  ...
  // 19. DISCOVERY MOMENT: EXTERNAL COORDINATION SOURCE
  {
    ...
    failResult: {
      ...
      xp: 0,
      effects: [],
      next: [{text: 'The Iron Compact liaison tracks cargo provenance the manifests obscure.', skill: 'lore', tag: 'safe', align: 'neutral', cid: '__arrive__'}]
    },
    fn: function() {
      advanceTime(1);
      G.telemetry.turns++;
  ...
  // 20. CONSPIRACY COMPLETE: EXTERNAL INFLUENCE CONFIRMATION
  {
    ...
    failResult: {
      ...
      xp: 0,
      effects: [],
      next: [{text: 'A formal Compact inquiry opens the Provision Compact transaction records.', skill: 'lore', tag: 'safe', align: 'neutral', cid: '__arrive__'}]
    },
    fn: function() {
      advanceTime(1);
      G.telemetry.turns++;
  ...
  // 22. CLUE: CHARTER MARK CONTAINER
  {
    ...
    failResult: {
      ...
      xp: 0,
      effects: [],
      next: [{text: 'The staging shed holds the crew lead\'s handoff carbons through end of week.', skill: 'survival', tag: 'safe', align: 'neutral', cid: '__arrive__'}]
    },
    fn: function() {
      advanceTime(1); G.telemetry.turns++; G.telemetry.actions++;
  ...
  // 23. ARCHETYPE-GATED: READING HARVEST CIRCLE
  {
    ...
    failResult: {
      ...
      xp: 0,
      effects: [],
      next: [{text: 'The night shift crew sees the full staging area before section leads divide it.', skill: 'persuasion', tag: 'safe', align: 'neutral', cid: '__arrive__'}]
    },
    fn: function() {
      advanceTime(1); G.telemetry.turns++; G.telemetry.actions++;
  ...
  // 25. ATMOSPHERE: THE GRANARY STEPS AT MIDDAY
  {
    ...
    failResult: {
      ...
      xp: 0,
      effects: [],
      next: [{text: 'The evening distribution is smaller and less managed than midday.', skill: 'lore', tag: 'safe', align: 'neutral', cid: '__arrive__'}]
    },
    fn: function() {
      advanceTime(1); G.telemetry.turns++; G.telemetry.actions++;
