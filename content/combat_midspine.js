 ...
 * Condition: G.archetype.group === 'combat' AND G.stage === 'Stage I' AND G.stageProgress[1] >= 5
...
const COMBAT_MIDSPINE_CHOICES = [
  ...
  // ——— NODE 2: THE TEST ———
  {
    ...
    fn: function() {
      ...
      const result = rollD20('combat', (G.skills.might || 0) + (G.skills.charm || 0) + Math.floor(G.level / 3));
      const target = 14;
