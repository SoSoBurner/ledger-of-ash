...
var SOREHEIM_PROPER_STAGE1_ENRICHED_CHOICES = [
  ...
  // 1. FOREMAN: QUOTA ESCALATION PATTERN
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(35, 'reading labor pressure patterns');
      G.stageProgress[1]++;
  ...
  // 2. QUOTA CLERK: LEDGER MANIPULATION
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(37, 'uncovering quota manipulation');
      G.stageProgress[1]++;
  ...
  // 3. MACHINERY SPECIALIST: EQUIPMENT SABOTAGE
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(35, 'reading equipment sabotage patterns');
      G.stageProgress[1]++;
  ...
  // 4. REPAIR WORKER: WORKPLACE ACCIDENTS [PROGRESS-GATED: reveals physical harm documentation pattern at mid-progress]
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(37, 'uncovering workplace endangerment');
      G.stageProgress[1]++;
  ...
  // 5. SHRINE HELPER: FAITH UNDER PRESSURE
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(35, 'reading spiritual pressure patterns');
      G.stageProgress[1]++;
  ...
  // 6. BROKER/MERCHANT: DISPLACEMENT PIPELINE
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(35, 'mapping labor displacement flows');
      G.stageProgress[1]++;
  ...
  // 7. RECORD KEEPER: DOCUMENTATION FALSIFICATION
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(37, 'uncovering documentation erasure');
      G.stageProgress[1]++;
  ...
  // 8. ARTISAN/CRAFTSPERSON: SKILL DEGRADATION
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(37, 'reading craft standard erosion');
      G.stageProgress[1]++;
  ...
  // 9. LABOR ANALYSIS TIER 1: WORKFORCE RESTRUCTURING
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(35, 'workforce composition analysis');
      G.stageProgress[1]++;
  ...
  // 10. PRODUCTION ANALYSIS TIER 2: QUOTA SYSTEM MECHANICS
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(37, 'exposing quota system architecture');
      G.stageProgress[1]++;
  ...
  // 11. INDUSTRIAL ANALYSIS TIER 1: SUPPLY CHAIN DISRUPTION
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(35, 'supply chain flow analysis');
      G.stageProgress[1]++;
  ...
  // 12. AUTHORITY STRUCTURE TIER 2: DECISION ISOLATION
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(37, 'exposing authority restructuring');
      G.stageProgress[1]++;
  ...
  // 13. COMMUNICATION NETWORK TIER 1: MESSAGE MONITORING
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(35, 'communication network analysis');
      G.stageProgress[1]++;
  ...
  // 14. RESISTANCE TIER 2: SUPPRESSION MECHANISMS
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(37, 'exposing suppression apparatus');
      G.stageProgress[1]++;
  ...
  // 15. SURVIVAL ANALYSIS TIER 1: WORKER VULNERABILITY
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(35, 'worker vulnerability mapping');
      G.stageProgress[1]++;
  ...
  // 16. NARRATIVE CONTROL TIER 2: OFFICIAL JUSTIFICATION STRUCTURE
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(37, 'official narrative deconstruction');
      G.stageProgress[1]++;
  ...
  // 17. STREET RUMOR: LABOR WHISPERS
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(32, 'parsing worker narrative');
      G.stageProgress[1]++;
  ...
  // 18. INSTITUTIONAL CRACK: QUOTA SYSTEM FAILURE PROOF
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(40, 'exposing quota system conspiracy');
      G.stageProgress[1]++;
  ...
  // 20. DISCOVERY MOMENT: EXTERNAL COORDINATION SOURCE
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(40, 'discovering origin source of displacement');
      G.stageProgress[1]++;
  ...
  // 21. CLUE: IRON COMPACT ROUTING MARKS
  {
    ...
    fn: function() {
      ...
      gainXp(36, 'reading shipment routing evidence');
  ...
  // 22. CLUE: WORKER DISPLACEMENT LOG
  {
    ...
    fn: function() {
      advanceTime(1); G.telemetry.turns++; G.telemetry.actions++;
      gainXp(34, 'recovering discarded documentation');
      if (!G.investigationProgress) G.investigationProgress = 0;
      if (!G.worldClocks) G.worldClocks = {};
      G.investigationProgress++;
      if (G.investigationProgress === 3) G.worldClocks.watchfulness = (G.worldClocks.watchfulness || 0) + 1;
  ...
  // 23. ARCHETYPE-GATED: READING THE PRESSURE
  {
    ...
    fn: function() {
      advanceTime(1); G.telemetry.turns++; G.telemetry.actions++;
      gainXp(35, 'reading crowd pressure');
  ...
  // 24. SOCIAL: APPROACH THE JUNIOR CLERK
  {
    ...
    fn: function() {
      advanceTime(1); G.telemetry.turns++; G.telemetry.actions++;
      gainXp(32, 'building low-pressure rapport');
  ...
  // 25. FACTION SEED: IRON COMPACT CONTACT
  {
    ...
    fn: function() {
      advanceTime(1); G.telemetry.turns++; G.telemetry.actions++;
      gainXp(36, 'making Iron Compact contact');
  ...
  // 26. ATMOSPHERE: THE RELIC STRATEGY WING PLAQUE
  {
    ...
    fn: function() {
      advanceTime(1); G.telemetry.turns++; G.telemetry.actions++;
      gainXp(27, 'reading local history');
  ...
  // 27. PERSONAL ARC SETUP: PROTECTING EVIDENCE
  {
    ...
    fn: function() {
      advanceTime(1); G.telemetry.turns++; G.telemetry.actions++;
      gainXp(34, 'securing evidence cache');
      if (!G.flags) G.flags = {};
  ...
  // 28. CLUE: RELIC STRATEGY WING CORRESPONDENCE
  {
    ...
    fn: function() {
      advanceTime(1); G.telemetry.turns++; G.telemetry.actions++;
      gainXp(39, 'intercepting strategic correspondence');
      if (!G.investigationProgress) G.investigationProgress = 0;
      if (!G.worldClocks) G.worldClocks = {};
      G.investigationProgress++;
      if (G.investigationProgress === 3) G.worldClocks.watchfulness = (G.worldClocks.watchfulness || 0) + 1;
  ...
  // 29. SHADOW RIVAL INTRO (final expansion choice)
  {
    ...
    fn: function() {
      advanceTime(1); G.telemetry.turns++; G.telemetry.actions++;
      gainXp(30, 'receiving rival warning');
      if (!G.flags) G.flags = {};
      if (!G.worldClocks) G.worldClocks = {};
  ...
  // SUPPRESSION: PAST-SEASON LEDGER REFUSED WITHOUT EXPLANATION
  {
    ...
    fn: function() {
      advanceTime(1); G.telemetry.turns++; G.telemetry.actions++;
      gainXp(25, 'reading institutional refusal pattern');
  ...
  // 30. SUPPRESSION: PROCEDURAL REFUSAL AT THE FACTOR AUTHORIZATION REGISTRY
  {
    ...
    fn: function() {
      advanceTime(1); G.telemetry.turns++; G.telemetry.actions++;
      gainXp(27, 'reading institutional refusal pattern');
  ...
  },
{
  ...
  fn: function() {
    advanceTime(1); G.telemetry.turns++; G.telemetry.actions++;
    gainXp(7, 'reading institutional refusal pattern');
...
},
{
  ...
  // 6D-A: Official cites procedure to avoid answering
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(27, 'procedural deflection from district coordinator');
      G.stageProgress[1]++;
  ...
  // 6D-B: Missing ledger entries 441-463
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(30, 'found missing entries in allocation ledger');
      G.stageProgress[1]++;
...

  {
    ...
    fn: function() {
      ...
      gainXp(5, 'quarry face observation');
      G.recentOutcomeType = 'observe';
    },
...

  {
    ...
    fn: function() {
      ...
      gainXp(5, 'Titan Tower observation');
      G.recentOutcomeType = 'observe';
    },
...

  {
    ...
    fn: function() {
      ...
      gainXp(5, 'dock output observation');
      G.recentOutcomeType = 'observe';
    },
...

  {
    ...
    fn: function() {
      ...
      if (result.success) {
        ...
        gainXp(7, 'tower allocation hall observation');
...

  {
    ...
    fn: function() {
      ...
      if (result.success) {
        ...
        gainXp(5, 'tower freight bridge transit');
      } else {
...

  {
    ...
    fn: function() {
      ...
      if (result.success) {
        ...
        gainXp(6, 'magma forge observation');
...
SOREHEIM_PROPER_STAGE1_ENRICHED_CHOICES.push(
  ...
  // ── ALLOCATION HALL (always-present anchor scene) ─────────────────────────
  {
    ...
    fn: function() {
      ...
      gainXp(22, 'reading the Allocation Hall system');
  ...
  // ── CREW GRIME MARKING (flavor + Soreheim-background mechanic) ────────────
  {
    ...
    fn: function() {
      advanceTime(1);
      if (G.telemetry) { G.telemetry.turns++; G.telemetry.actions++; }
      gainXp(20, 'understanding crew floor-marking system');
  ...
  // ── CRAFT-SKILLED CHOICES (benefits engineer archetype) ──────────────────
  {
    ...
    fn: function() {
      advanceTime(1);
      if (G.telemetry) { G.telemetry.turns++; G.telemetry.actions++; }
      gainXp(32, 'reading tool wear against quota pressure');
      G.stageProgress[1] = (G.stageProgress[1] || 0) + 1;
...

  {
    ...
    fn: function() {
      advanceTime(1);
      if (G.telemetry) { G.telemetry.turns++; G.telemetry.actions++; }
      gainXp(35, 'reading structural stress evidence');
      G.stageProgress[1] = (G.stageProgress[1] || 0) + 1;
...

  {
    ...
    fn: function() {
      advanceTime(1);
      if (G.telemetry) { G.telemetry.turns++; G.telemetry.actions++; }
      gainXp(30, 'reading forge calibration drift');
...

  {
    ...
    fn: function() {
      advanceTime(1);
      if (G.telemetry) { G.telemetry.turns++; G.telemetry.actions++; }
      gainXp(34, 'reading ward modification intent');
  ...
  // ── OATH-CYCLE RITUAL (fires periodically on G.dayCount % 28) ────────────
  {
    ...
    fn: function() {
      advanceTime(1);
      if (G.telemetry) { G.telemetry.turns++; G.telemetry.actions++; }
      gainXp(27, 'witnessing Soreheim oath-cycle ritual');
  ...
  // The bridge deviation report traces north
  {
    ...
    fn: function() {
      advanceTime(1);
      if (G.telemetry) { G.telemetry.turns++; G.telemetry.actions++; }
      gainXp(35, 'tracing bridge deviation authorization');
      G.stageProgress[1] = (G.stageProgress[1] || 0) + 1;
  ...
  // The displaced workers' records were transferred to the central bureau
  {
    ...
    fn: function() {
      advanceTime(1);
      if (G.telemetry) { G.telemetry.turns++; G.telemetry.actions++; }
      gainXp(32, 'tracing records transfer destination');
      G.stageProgress[1] = (G.stageProgress[1] || 0) + 1;
  ...
  // Investigation wall — the trail ends here, points north
  {
    ...
    fn: function() {
      advanceTime(1);
      if (G.telemetry) { G.telemetry.turns++; G.telemetry.actions++; }
      gainXp(27, 'reading the pattern of closed doors');
      G.stageProgress[1] = (G.stageProgress[1] || 0) + 1;
