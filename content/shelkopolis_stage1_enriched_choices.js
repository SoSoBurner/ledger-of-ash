...
var SHELKOPOLIS_STAGE1_ENRICHED_CHOICES = [
  ...
  // 6. MARKET BROKER: TRADE FLOW CHANGES
  {
    ...
    fn: function() {
      ...
      const result = rollD20('charm', (G.skills.charm || 0) + (G.skills.insight || 0) / 2 + Math.floor(G.level / 3));
...

{
...
},
  {
    ...
    fn: function() {
      ...
      var result = rollD20('persuasion', (G.skills.charm||0) + Math.floor(G.level/3) + (typeof getTraitBonus==='function'?getTraitBonus('persuasion'):0) + (typeof getEquipmentBonus==='function'?getEquipmentBonus('persuasion'):0));
      if (result.total >= 8) {
