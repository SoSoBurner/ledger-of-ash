...

  {
    ...
    fn: function() {
      ...
      if (result.total >= 14 || result.isCrit) {
        ...
        G.lastResult = `The research package reaches the Mimolot Academy faculty council under Quenra Quillfire's authority — hand-delivered to the council secretary's intake desk, signed and logged. The faculty council convenes a formal academic review within two days. The Northern Glyph Oversight Commission suppression order is declared procedurally void under Academy academic freedom doctrine: the body that issued it has no standing in the Academy's jurisdiction. Stage III begins with institutional backing already in place.`;
