      ...
      (window._rawRenderChoices || window.renderChoices)([
        {
          ...
          tag: 'bold',
          action: function() { if (typeof gainXp === 'function') gainXp(10, 'choice'); studyNotes(); }
        },
        {
          id: 'maren_evidence_take',
          text: 'A copy in your coat. The clerk is still on break.',
          tag: 'risky',
          action: function() { if (typeof gainXp === 'function') gainXp(10, 'choice'); copyNotes(); }
        },
        {
          id: 'maren_evidence_leave',
          text: 'Whoever left this decided you should find it. The question is why.',
          tag: 'safe',
          action: function() { if (typeof gainXp === 'function') gainXp(10, 'choice'); leaveNotes(); }
        }
      ]);
    }, 400);
  }
