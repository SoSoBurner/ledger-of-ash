...
var PANIM_HAVEN_STAGE1_ENRICHED_CHOICES = [
  ...
  // 1. SHRINE ATTENDANT: OFFERING PATTERNS CORRUPTED
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(35, 'reading offering corruption patterns');
      G.stageProgress[1]++;
  ...
  // 2. SCRIBE: MEDIATION RECORDS TAMPERED
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(37, 'uncovering ledger manipulation');
      G.stageProgress[1]++;
  ...
  // 3. MEMORIAL COUNSELOR: GRIEF PROCESSING CHANGING
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(35, 'reading grief manipulation');
      G.stageProgress[1]++;
  ...
  // 4. PROCESSIONAL COORDINATOR: ROUTE DIVERSIONS
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(35, 'reading ritual route manipulation');
      G.stageProgress[1]++;
  ...
  // 5. CHAPEL KEEPER: BLESSING FAILURE
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(35, 'reading divine protection corruption');
      G.stageProgress[1]++;
  ...
  // 6. RITUAL AUTHORITY: DOCTRINE CHANGES
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(37, 'confronting institutional authority');
      G.stageProgress[1]++;
  ...
  // 8. MEDIATOR CLERIC: CASE OUTCOMES RIGGED
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(37, 'uncovering mediation bias');
      G.stageProgress[1]++;
  ...
  // 9. LORE TIER 1: RITUAL FORMULA ANALYSIS
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(35, 'ritual formula analysis');
      G.stageProgress[1]++;
  ...
  // 10. LORE TIER 2: DIVINE BALANCE DOCTRINE
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(37, 'tracing doctrine corruption');
      G.stageProgress[1]++;
  ...
  // 11. CRAFT TIER 1: OFFERING PREPARATION INSPECTION
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(35, 'offering preparation analysis');
      G.stageProgress[1]++;
  ...
  // 12. CRAFT TIER 2: MEDIATION LEDGER DOCUMENT ANALYSIS
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(37, 'exposing document forgery');
      G.stageProgress[1]++;
  ...
  // 13. SURVIVAL TIER 1: ROUTE NETWORK ANALYSIS
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(35, 'messenger route analysis');
      G.stageProgress[1]++;
  ...
  // 14. SURVIVAL TIER 2: WAYSTATION INSPECTION
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(37, 'uncovering waystation stockpiles');
      G.stageProgress[1]++;
  ...
  // 15. STREET RUMOR: FAMILIES BEING DIVIDED
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(32, 'parsing community grievance narratives');
      G.stageProgress[1]++;
  ...
  // 16. INSTITUTIONAL CRACK: SHRINE WORKER DEFECTION
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(37, 'turning institutional witness');
      G.stageProgress[1]++;
      addHeat('panim', 1);
  ...
  // 18. LAYERED REVELATION: MEDIATION AS INSTRUMENT
  {
    ...
    fn: function() {
      ...
      G.telemetry.turns++;
      G.telemetry.actions++;
      gainXp(40, 'exposing mediation conspiracy');
      G.stageProgress[1]++;
      addHeat('panim', 1);
  ...
  // 19. CLUE: MEDIATION HALL CASE FRAGMENTS
  {
    ...
    fn: function() {
      ...
      gainXp(36, 'reading Mediation Hall case register');
  ...
  // 20. CLUE: COASTAL ROUTE PASSAGE RECORDS
  {
    ...
    fn: function() {
      advanceTime(1); G.telemetry.turns++; G.telemetry.actions++;
      gainXp(35, 'tracing coastal passage records');
      if (!G.investigationProgress) G.investigationProgress = 0;
      if (!G.worldClocks) G.worldClocks = {};
      G.investigationProgress++;
      if (G.investigationProgress === 3) G.worldClocks.watchfulness = (G.worldClocks.watchfulness || 0) + 1;
  ...
  // 21. ARCHETYPE-GATED: READING THE MEDIATION QUARTER
  {
    ...
    fn: function() {
      advanceTime(1); G.telemetry.turns++; G.telemetry.actions++;
      gainXp(34, 'reading mediation quarter');
  ...
  // 23. ATMOSPHERE: TAZREN'S SHADOW
  {
    ...
    xpReward: 26,
    failResult: function() {
      addNarration('', 'Lamp resin and ritual incense settle into the shrine threshold while a mediator clergy member turns her attention to the next petitioner. The exchange does not open. You leave the offering rail before the rite-bell marks the hour.', (G && G.lastResultType) || 'failure');
      loadStageChoices(G.location);
    },
    fn: function() {
      advanceTime(1); G.telemetry.turns++; G.telemetry.actions++;
      gainXp(26, 'asking about Tazren');
  ...
  // 25. SOCIAL: THE CASE THAT WAS CLOSED YESTERDAY
  {
    ...
    fn: function() {
      advanceTime(1); G.telemetry.turns++; G.telemetry.actions++;
      gainXp(33, 'interviewing recent ghost case complainant');
  ...
  // TYPE: INFORMATION — WORLD COLOR VIGNETTE
  {
    ...
    fn: function() {
      advanceTime(1); G.telemetry.turns++; G.telemetry.actions++;
      gainXp(19, 'observing memorial hall offering smoke');
  ...
  // TYPE: INFORMATION — ARCHETYPE GATE (Saint — Support family)
  {
    ...
    fn: function() {
      ...
      if (family !== 'Support') {
        ...
        gainXp(15, 'noting blessing material change');
        G.recentOutcomeType = 'observe'; maybeStageAdvance(); return;
      }
      gainXp(36, 'analyzing blessing material composition change');
      G.stageProgress[1]++;
  ...
  // TYPE: INFORMATION — BACKGROUND FLAVOR
  {
    ...
    fn: function() {
      advanceTime(1); G.telemetry.turns++; G.telemetry.actions++;
      gainXp(27, 'reviewing shrine donation ledger');
...
,
...

  {
    ...
    fn: function() {
      ...
      gainXp(5, 'route board observation');
...

  {
    ...
    fn: function() {
      ...
      gainXp(5, 'waystation log observation');
      G.recentOutcomeType = 'observe';
    },
